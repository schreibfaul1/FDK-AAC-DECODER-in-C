...
static void adjustTimeSlotHQ_GainAndNoise(int32_t *ptrReal, int32_t *ptrImag,
                                          HANDLE_SBR_CALCULATE_ENVELOPE h_sbr_cal_env, ENV_CALC_NRGS_t *nrgs,
...
static void adjustTimeSlotHQ(int32_t *ptrReal, int32_t *ptrImag, HANDLE_SBR_CALCULATE_ENVELOPE h_sbr_cal_env,
                             ENV_CALC_NRGS_t *nrgs, int32_t lowSubbands, int32_t noSubbands, int32_t scale_change,
                             int16_t smooth_ratio, int32_t noNoiseFlag, int32_t filtBufferNoiseShift);
...
/*static*/ void aliasingReduction(int32_t *degreeAlias,                            /*!< estimated aliasing for each QMF
                                                                                       channel */
                                  ENV_CALC_NRGS_t *nrgs, uint8_t *useAliasReduction, /*!< synthetic sine energy for each
    ...
    for(; i < i_stop; i++) {
        ...
        */
        ...
        /* Always fully initialize the temporary energy table. This prevents
           ...
           certification set. */
        memset(pNrgs, 0, sizeof(ENV_CALC_NRGS_t));
...
static void calcSubbandGain(int32_t        nrgRef,   /*!< Reference Energy according to envelope data */
                            ...
                            ENV_CALC_NRGS_t *nrgs, int32_t i, int32_t tmpNoise, /*!< Relative noise level */
...
*/
static void calcAvgGain(ENV_CALC_NRGS_t *nrgs, int32_t lowSubband, /*!< Begin of the limiter band */
...
static void adjustTimeSlot_EldGrid(int32_t       *ptrReal, /*!< Subband samples to be adjusted, real part */
                                   ENV_CALC_NRGS_t *nrgs, uint8_t *ptrHarmIndex, /*!< Harmonic index */
