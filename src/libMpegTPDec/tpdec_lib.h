...
TRANSPORTDEC_ERROR_t transportDec_FillData(const HANDLE_TRANSPORTDEC hTp, uint8_t *pBuffer, const uint32_t bufferSize, uint32_t *pBytesValid, const int32_t layer);
